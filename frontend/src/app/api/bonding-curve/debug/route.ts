      ...
      try {
        ...
        if (response && response.length > 0) {
          ...
          try {
            ...
            const curveInfo = resources.find((r) =>
              r.type.includes("::bonding_curve::CurveInfo"),
            );
            const capabilities = resources.find((r) =>
      ...
      try {
        ...
        try {
          const resourceAddrRequest: Types.ViewRequest = {
            ...
            arguments: [
              contractAddress,
              Array.from(Buffer.from("mintara_bonding_curve")),
            ],
          };
          ...
          try {
            ...
            console.error(
              "Error calculating @mintara resource address:",
              error,
            );
          }
          ...
          return NextResponse.json({
            ...
            contractAddress,
            isInitialization,
            resourceSeed: "mintara_bonding_curve",
          ...
          console.error(
            "Error calling create_resource_address view function:",
            error,
          );
        }
      } catch (error) {
